...
class Setup(object):
    ...
    def populate_db(self):
        ...
        scenario1.save()
        Step.create(name='Step1', scenario=scenario1, codeStep=codeStep1)
        Step.create(name='Step2', scenario=scenario1, codeStep=codeStep2)
        scenario2 = Scenario.create(name='Scenario2', feature=feature1, is_background=True)
        scenario2.tags.add(tag2)
        scenario2.save()
        Step.create(name='Step3', scenario=scenario2, codeStep=codeStep3)
        Step.create(name='Step4', scenario=scenario2, codeStep=codeStep4)
        scenario3 = Scenario.create(name='Scenario3', feature=feature2, is_background=True)
        scenario3.tags.add(tag1)
        scenario3.save()
        Step.create(name='Step5', scenario=scenario3, codeStep=codeStep5)
        Step.create(name='Step6', scenario=scenario3, codeStep=codeStep6)
        scenario4 = Scenario.create(name='Scenario4', feature=feature2, is_background=True)
        scenario4.tags.add(tag2)
        scenario4.save()
        Step.create(name='Step7', scenario=scenario4, codeStep=codeStep7)
        Step.create(name='Step8', scenario=scenario4, codeStep=codeStep8)
